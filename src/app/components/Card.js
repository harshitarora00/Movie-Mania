...
const Card = ({ result }) => {
  return (
    ...
    sm:shadow-md rounded-lg sm:border sm:border-slate-400 group sm:m-2 transition-shadow duration-200 size-10 
    "
    >
      <Link href={`/movie/${result.id}`}>
        ...
        <div className="p-2">
          ...
          <p className="flex items-center">
            ...
            <FaHeart className="text-red-500 ml-3 mr-1" /> {result.vote_count}
          </p>
        </div>
      </Link>
    </div>
